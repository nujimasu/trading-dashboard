const STYLE = `
  ...
  .lg-section p { margin:8px 0; color:#b4c2d4; font-size:.82rem; }
  ...
  .lg-table-wrap { width:100%; margin-top:13px; overflow-x:auto; border:1px solid #2c3e58; border-radius:10px; }
